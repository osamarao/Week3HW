...
import static com.applejay.android.taskmanager.tasks.TasksSQLiteOpenHelper.*;
...
import com.applejay.android.taskmanager.tasks.TasksSQLiteOpenHelper;
...
public class TaskManagerApplication extends Application {
	...
	public void add(Task t) {
		assert(null !=t); // catches if t references null
			...
			long id = database.insert(TASKS_TABLE, null, values); // returns an id after insert
	...
	public void saveTask(Task t) {
		...
		try {	
			database.update(TASKS_TABLE, values, where, new String[]{id+""}); // protect against sql injections (sanitization process)
		}
		catch (Exception e) {e.printStackTrace();};
	}
